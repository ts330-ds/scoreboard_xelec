...
class ArcheryIndividualRoundMobile extends StatelessWidget {
  const ArcheryIndividualRoundMobile({super.key});
                  ...
                  children: [
                    ...
                    >(
                      builder: (context, timerState) {
                        ...
                        final isPrestart =
                            timerState.phase ==
                            ArcheryIndividualTimerPhase.prestart;
                    ...
                    >(
                      builder: (context, timerState) {
                        final isLeft =
                            timerState.activeSide == ArcheryIndividualSide.left;
                        final isRight =
                        ...
                        children: [
                          ...
                          >(
                            builder: (context, timerState) {
                              final isRunning =
                                  timerState.status ==
                                  ArcheryIndividualTimerStatus.running;
                              final isPaused =
                                  timerState.status ==
                                  ArcheryIndividualTimerStatus.paused;
                              ...
                              return Row(
                                ...
                                children: [
                                  _ControlButton(
                                    ...
                                    onTap: () => context
                                        .read<ArcheryIndividualTimerCubit>()
                                        .start(),
                                  ),
                                  SizedBox(width: 6.w),
                                  if (isPaused)
                              ...
                              return Row(
                                ...
                                children: [
                                  _SideSelectButton(
                                    ...
                                    onTap: () => context
                                        .read<ArcheryIndividualTimerCubit>()
                                        .switchSide(ArcheryIndividualSide.left),
                                  ),
                                  SizedBox(width: 12.w),
                                  _SideSelectButton(
                                    label: 'RIGHT TEAM',
