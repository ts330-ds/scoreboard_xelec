...
class AbcConfigScreen extends StatefulWidget {
  const AbcConfigScreen({super.key});

  @override
  State<AbcConfigScreen> createState() => _AbcConfigScreenState();
}

class _AbcConfigScreenState extends State<AbcConfigScreen> {
  static const int _minSeconds = 1;
  static const int _maxSeconds = 999;
  ...
  late final AbcTimerCubit _timerCubit;
  ...
  void _applyConfig() {
    ...
    context.pushReplacement(AppPaths.archeryAbcScreen);
  }
}
