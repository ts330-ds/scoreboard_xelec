...
class Ab_CdConfigScreen extends StatefulWidget {
  const Ab_CdConfigScreen({super.key});

  @override
  State<Ab_CdConfigScreen> createState() => _Ab_CdConfigScreenState();
}

class _Ab_CdConfigScreenState extends State<Ab_CdConfigScreen> {
  ...
  late final Ab_CdTimerCubit _timerCubit;
  ...
  void initState() {
    super.initState();
    _timerCubit = sl<Ab_CdTimerCubit>();
  ...
  void _applyConfig() {
    ...
    context.pushReplacement(AppPaths.archeryAb_CdScreen);
  }
}
