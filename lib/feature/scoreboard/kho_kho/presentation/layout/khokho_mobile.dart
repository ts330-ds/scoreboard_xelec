            ...
            Expanded(
              ...
              child: Column(
                children: [
                  const KhokhoHeader(),
                  Expanded(
                    child: BlocBuilder<KhokhoControllerCubit, KhokhoControllerState>(
                        ...
                        return Row(
                          children: [
                            ...
                            KhokhoTeamCard(
                              ...
                              status: state.isTeam1Chasing ? "Chase" : "Defend",
                              backgroundColor: state.team1Color,
                              // Blue
                              scoreBoxColor: const Color(0xFF2C5292),
                              // Lighter Blue
                              statusColor: state.isTeam1Chasing ? const Color(0xFFFFC107) : const Color(0xFF28A745),
                            ),

                            // Divider Line
                            const VerticalDivider(width: 2, color: Colors.black, thickness: 2),

                            // Team 2 (Red)
                            KhokhoTeamCard(
                              teamName: state.team2Name,
                              score: state.team2Score.toString().padLeft(2, '0'),
                              status: state.isTeam1Chasing ? "Defend" : "Chase",
                              backgroundColor: state.team2Color,
                              // Red
                              scoreBoxColor: const Color(0xFF8B0000),
                              // Darker Red
                              statusColor: state.isTeam1Chasing ? const Color(0xFF28A745) : const Color(0xFFFFC107),
                            ),
                          ],
                        );
                      },
