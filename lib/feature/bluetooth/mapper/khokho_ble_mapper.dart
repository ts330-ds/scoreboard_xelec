...
class KhoKhoBleMapper {
  ...
  String setTeam1Color(String rgb565) => _log("KKC1$rgb565");
  String setTeam2Color(String rgb565) => _log("KKC2$rgb565");

  // Chase/Defense (1=team1 chasing, 2=team2 chasing)
  String setChasingTeam(int team) => _log("KKCD$team");

  // Inning (1 or 2) - displays as "1/2" or "2/2"
  String setInning(int inning) => _log("KKIN$inning");

  // Turn (1-4) - displays as "X/4"
  String setTurn(int turn) => _log("KKTU$turn");

  // Turn Timer (countdown)
  String setTurnTimerMinutes(int minutes) => _log("KKTT$minutes");
  String startTurnTimer() => _log("KKTS");
  String pauseTurnTimer() => _log("KKTP");
  String resetTurnTimer() => _log("KKTR");

  // Match Timer (count-up)
  String setMatchTimerMinutes(int minutes) => _log("KKMT$minutes");
